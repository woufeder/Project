...
<body>
  <div class="container px-3 mt-3">
    ...
    <div class="my-2 d-flex">
      ...
      <a class="btn btn-sm btn-add" href="./add.php">增加資料</a>
    </div>
    ...
    <div class="mb-2">
      ...
      <?php foreach ($rows as $index => $row): ?>
        <div class="list bg-light text-dark px-3">
          ...
          <div class="control">
            <button class="btn btn-sm btn-del" data-id="<?= $row["id"] ?>">刪除</button>
  ...
  <script>
    ...
    btnSearch.addEventListener("click", function () {
      ...
      if (midValue != 0) {
        window.location.href = `./index.php?mid=${midValue}&brand_id=${brandIDValue}&search=${query}`;
        return;
      }
      window.location.href = `./index.php?mid=${midValue}&cid=${cidValue}&brand_id=${brandIDValue}&search=${query}`;
